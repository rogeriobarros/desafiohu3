...
/**
 * Performance test for the TravelPackages entity.
 */
class TravelPackagesGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the TravelPackages entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all travelPackages")
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created travelPackages")
                .get("${new_travelPackages_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created travelPackages")
            .delete("${new_travelPackages_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
