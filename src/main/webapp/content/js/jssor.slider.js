  ...
  var b = k.$Jssor$ = new function() {
      ...
      function w(f, l) {
        ...
        w = function(e, c) {
          ...
          if (c.$Transform) if (d) yb(h.$CreateCallback(j, O, e, c));
          else a(e, c)
        };
      ...
      function wb(c, a) {
        ...
        n(c, function(c, d) {
          var e = c;
          if (a[d] != g) if (h.$IsNumeric(c)) e = c + a[d];
          else e = wb(c, a[d]);
          b[d] = e
        });
        return b
    ...
    function o(B, h, a, w, o, m) {
      ...
      b.$Each(p, function(h, j) {
        b.$Each(h, function(G) {
          ...
          if (a.$Zoom || a.$Rotate) {
            var H = d;
            if (b.$IsBrowserIe9Earlier()) if (a.$Cols * a.$Rows > 1) H = l;
            else I = l;
            if (H) {
    ...
    function Bc(k, f) {
      ...
      function ab(b) {
        if (b == R && s == f) {
          if (!g) {
            var a = j;
            if (A) if (A.$Index == f) a = A.$GetProcessor();
            else A.$Clear();
            Y();
            g = new zc(k, f, a, q);
            g.$SetPlayer(p)
    ...
    function j(d, c) {
      ...
      b.$Each(d, function(d, f) {
        ...
        if (e) {
          ...
          else if (c) if (b.$IsNumeric(d)) d = o[d];
          a[e] = d
        }
      });
      return a
