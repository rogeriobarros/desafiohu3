(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('desafiohu3App.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-desafiohu3App-error');
                var entityKey = httpResponse.headers('X-desafiohu3App-params');
                if (errorHeader) {
